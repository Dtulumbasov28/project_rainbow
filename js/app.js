(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".room__img-slider")) new core(".room__img-slider", {
            ...
            if (document.querySelector(".services__block-img")) new core(".services__block-img", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".partners-block__photo-slider")) new core(".partners-block__photo-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        var script_checkbox = document.getElementById("popup-form__input-checkbox");
        var btn_submit = document.querySelector(".popup-form__button");
        script_checkbox.addEventListener("change", (() => {
            if (script_checkbox.checked) btn_submit.removeAttribute("disabled"); else btn_submit.setAttribute("disabled", true);
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
